...
import {type ColunaTabela, Tabela} from "../../components/tabela/Tabela";
...
export const PaginaCargos: React.FC = () => {
    ...
    const cargosFiltrados = cargos.filter(
        (c) =>
            c.descricaoDoCargo.toLowerCase().includes(filtroNome.toLowerCase()) &&
    ...
    const colunas: ColunaTabela<ICargos>[] = [
        {
            ...
            render: (cargo) => (
                <button
                    ...
                    onClick={() =>
                        navigate(
                            dicionarioDeRotas.cargos.id.replace(":id", String(cargo.codigoDoCargo)),
                        )
                    }
                    title="Editar Cargo"
                >
            ...
            actions={
                <>
                    ...
                    <Button
                        variant="outline"
                        size="medium"
                        onClick={() => navigate(dicionarioDeRotas.cargos.cadastrar)}
                    >
                        <AppIcons.Adicionar/>
                        Novo Cargo
                    </Button>
        ...
        >
            <Card>
                ...
                <Tabela
                    ...
                    keyExtractor={(cargo, index) => cargo.codigoDoCargo ?? cargo.descricaoDoCargo ?? index}
                />
            </Card>
        </ListagemLayout>
    );
